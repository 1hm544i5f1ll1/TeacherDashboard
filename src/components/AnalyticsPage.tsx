...
import { 
  ...
  ArrowLeft, Eye, Calendar, Activity
} from 'lucide-react';
          ...
          {dashboard.recentViews.slice(0, 3).map((view) => (
            <div key={view.id} className="flex items-center justify-between text-sm">
              <div className="flex items-center space-x-2">
                ...
                <span className="nature-subtext">User {view.userId.slice(-1)}</span>
              </div>
      ...
      <main className="max-w-7xl mx-auto p-8">
        <div className="space-y-8">
          ...
          <div className="space-y-6">
            <div className="flex items-center justify-between">
              <h2 className="text-2xl font-bold nature-heading">Dashboard Performance</h2>
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      <div className="font-medium nature-heading">
                        User {activity.userId.slice(-1)} visited {activity.dashboardName}
                      </div>
