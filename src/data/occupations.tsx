      ...
      features: [
        {
          ...
          color: 'blue',
          link: 'https://classroom.google.com/attendance',
          status: 'pending'
        },
        {
          id: '2',
          ...
          color: 'blue',
          link: 'https://classroom.google.com/courses',
          status: 'pending'
        },
        {
          id: '3',
          ...
          color: 'blue',
          link: 'https://gradebook.schoology.com',
          status: 'pending'
        },
        {
          id: '4',
          ...
          metric: 'Next: Math - Algebra',
          color: 'blue',
          link: 'https://planbook.com/lesson-plans',
          status: 'pending'
        },
        {
          id: '5',
          ...
          color: 'blue',
          link: 'https://remind.com/messages',
          status: 'pending'
        },
        {
          id: '6',
          ...
          color: 'blue',
          link: 'https://analytics.powerschool.com',
          status: 'pending'
        }
      ]
    },
